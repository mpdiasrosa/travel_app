...
class ParticipantsRepository:
    ...
    def registry_participantes(self, participant_infos: Dict) -> None:
        cursor = self.__conn.cursor()  # Fixed typo here
        cursor.execute(
            '''
    ...
    def find_participantes_from_trip(self, trip_id: str) -> List[Tuple]:
